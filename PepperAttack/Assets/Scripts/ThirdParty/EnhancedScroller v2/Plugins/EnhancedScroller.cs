...
namespace EnhancedUI.EnhancedScroller
{
	...
	public class EnhancedScroller : MonoBehaviour
	{
		...
		/// <returns></returns>
		public EnhancedScrollerCellView GetCellView(EnhancedScrollerCellView cellPrefab, Transform tfParent = null)
		{
			...
			if (cellView == null)
			{
				...
				//Vector3 _pos = cellView.transform.localPosition;
				//_pos.z = 0;
				//cellView.transform.localPosition = _pos;
			}
